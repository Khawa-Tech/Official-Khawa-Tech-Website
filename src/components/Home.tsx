...
export default function HeroSection() {
    return (
        ...
        >
            ...
            {/* ── Content wrapper ── */}
            <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 lg:px-12 xl:px-16 py-16 lg:py-0 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">

                {/* ── LEFT: Text content ── */}
                <div className="flex-1 flex flex-col items-start gap-6 text-center lg:text-left items-center lg:items-start">

                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 text-xs font-semibold tracking-widest text-foreground/80 uppercase">
                        <span className="w-2 h-2 rounded-full bg-primary animate-pulse" />
                        Agence de développement
                    </div>

                    {/* Heading */}
                    <h1 className="text-4xl sm:text-5xl xl:text-6xl font-extrabold leading-[1.1] tracking-tight text-foreground">
                        Nous créons des <br />
                    ...
                    {/* Subtitle */}
                    <p className="max-w-md text-foreground/60 text-base sm:text-lg leading-relaxed">
                ...
                {/* ── RIGHT: Illustration ── */}
                <div className="flex-1 relative w-full max-w-[600px] lg:max-w-none aspect-square lg:aspect-auto lg:h-[560px]">
